<?php
namespace Budgetlens\CopernicaRestApi\Tests\Unit\Resources;
...
class BaseResourceTest extends TestCase
{
    ...
    public function encodingMalformedJsonThrowsAnException()
    {
        ...
        $this->expectExceptionMessage(
            "Error encoding resource [Budgetlens\CopernicaRestApi\Tests\Unit\Resources\ResourceStub] to JSON: " .
